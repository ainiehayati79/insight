...
def insert_result(name, age, gender, classification, *scores):
    ...
    c.execute('CREATE TABLE IF NOT EXISTS results (name TEXT, age REAL, gender TEXT, classification TEXT, total_score REAL, Q1 TEXT, Q2 TEXT, Q3 TEXT, Q4 TEXT, Q5 TEXT, Q6 TEXT, Q7 TEXT, Q8 TEXT, Q9 TEXT, Q10 TEXT, Q11 TEXT, Q12 TEXT, Q13 TEXT)')
    c.execute('INSERT INTO results (name, age, gender, classification, total_score, Q1, Q2, Q3, Q4, Q5, Q6, Q7, Q8, Q9, Q10, Q11, Q12, Q13) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
              (name, age, gender, classification, total_score, *scores))
    conn.commit()
...
def prediction_page():
    ...
    if st.button('Predict'):
        ...
        print("Score Mappings:", score_mappings)
        print("Total Score:", total_score)

        # Insert result into the database
        classification = get_classification(total_score)
        insert_result(name, age, gender, classification, *scores)
...
def dashboard_page():
    ...
    df = pd.DataFrame(rows, columns=['Name', 'Age', 'Gender', 'Classification', 'total_score', 'Q1', 'Q2', 'Q3', 'Q4', 'Q5', 'Q6', 'Q7', 'Q8', 'Q9', 'Q10', 'Q11', 'Q12', 'Q13'])
